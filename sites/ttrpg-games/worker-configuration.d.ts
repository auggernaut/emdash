/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5b0ca722aad8d188366168eaf87ff95)
// Runtime types generated with workerd@1.20260415.1 2026-03-01 disable_nodejs_process_v2,no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		SEOBOT_API_KEY: string;
		SEOBOT_SYNC_SECRET: string;
		SEOBOT_SYNC_INTERVAL_MINUTES: string;
		EMDASH_AUTH_SECRET: string;
		EMDASH_PREVIEW_SECRET: string;
		CLOUDINARY_API_SECRET: string;
		CLOUDINARY_API_KEY: string;
		EMDASH_GAME_SUBMISSION_NOTIFICATION_EMAIL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEOBOT_API_KEY" | "SEOBOT_SYNC_SECRET" | "SEOBOT_SYNC_INTERVAL_MINUTES" | "EMDASH_AUTH_SECRET" | "EMDASH_PREVIEW_SECRET" | "CLOUDINARY_API_SECRET" | "CLOUDINARY_API_KEY" | "EMDASH_GAME_SUBMISSION_NOTIFICATION_EMAIL">> {}
}
